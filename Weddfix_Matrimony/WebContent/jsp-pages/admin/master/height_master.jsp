...
jQuery(document).ready(function() {
	jq(function() {		
		jq("#grid").jqGrid(
		{
		   	url : 'load_height_master',
		   	editurl:"edit_height_master",
		   	pageable: true,
		   	loadui:"enable",
			datatype: 'json',
			mtype: 'post',
		   	colNames:['Height Id', 'Feet/Inches','Feet/Inches Description','Is Active'],
		   	colModel:[
		   		     {name:'id',align:'center', index:'id', width:100,editable:true,hidden:true,editoptions: {readonly:false,hidden:true,size:10}},
                    {name:'feetInches',index:'feetInches', width:100,editable:true,editrules:{required:true},editoptions:{size:10,maxlength: 30},searchoptions:{sopt: ['cn']}},
                    {name:'feetInchesDesc',index:'feetInchesDesc', width:100,editable:true,editrules:{required:true},editoptions:{size:10,maxlength: 250},searchoptions:{sopt: ['cn']}},
...
// 		    					jQuery('#feetInches',form).attr('readonly','readonly');
		    				},afterSubmit: function (response, postdata) {
		                 		window.location.reload(true);
		                	 } },
		    		        {closeAfterAdd:true,beforeShowForm: function(form) {
// 		    					jQuery('#feetInches',form).removeAttr('readonly');		                    
		                  	},
		                  	...
		                  	beforeSubmit:function(postdata,form){	
		        					...
		        					if(renum.test(name) == false){
		        		            		  return [false,'Feet/Inches should not have special characters'];
		        					}}
		        					return [true,','];
...
<body>
	<s:url var="remoteurl" action="load_height_master" id="actionName" />
